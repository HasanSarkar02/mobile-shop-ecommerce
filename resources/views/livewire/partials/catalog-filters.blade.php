<div class="space-y-6">
    ...
    <div>
        ...
        <div class="flex items-center gap-2">
            <input type="number" wire:model.live.debounce.600ms="priceMin" placeholder="Min" min="0"
                class="w-full rounded-lg border border-gray-200 dark:border-gray-800 dark:bg-gray-900 text-sm focus:border-[var(--brand)] focus:ring-[var(--brand)] transition">
    ...
    <div class="space-y-1 pt-1 border-t border border-gray-100 dark:border-gray-800">
        <label class="flex items-center gap-2 text-sm cursor-pointer select-none py-1.5">
            <input type="checkbox" wire:model.live="inStockOnly"
                class="rounded border border-gray-300 dark:border-gray-700 text-[var(--brand)] focus:ring-[var(--brand)]">
            In Stock
        </label>
        <label class="flex items-center gap-2 text-sm cursor-pointer select-none py-1.5">
    ...
    @if ($facets['brands']->isNotEmpty())
        <div class="pt-1 border-t border border-gray-100 dark:border-gray-800">
    ...
    @foreach ($facets['attributes'] as $code => $facet)
        <div class="pt-1 border-t border border-gray-100 dark:border-gray-800" x-data="{ expanded: true }">
                    ...
                    <label class="flex items-center justify-between gap-2 text-sm cursor-pointer select-none py-1.5">
                        <span class="flex items-center gap-2">
                            <input type="checkbox"
                                ...
                                class="rounded borderborder-gray-300 dark:border-gray-700 text-[var(--brand)] focus:ring-[var(--brand)]">
                            {{ $option['value'] }}
                        </span>
