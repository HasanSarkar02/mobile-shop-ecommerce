...
class ViewOrder extends ViewRecord
{
    ...
    protected function getHeaderActions(): array
    {
        return [
            ...
            ])->label('Documents')->icon('heroicon-o-document-duplicate')->color('gray')->button(),
            ...
            ])->label('Payments')->icon('heroicon-o-banknotes')->color('gray')->button(),
            ...
            ])->label('Fulfillment')->icon('heroicon-o-truck')->color('gray')->button(),
