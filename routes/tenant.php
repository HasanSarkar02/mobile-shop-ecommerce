...
use App\Http\Controllers\Storefront\OutletController;
...
$registerTenantRoutes = function (): void {
    ...
    Route::get('/offer/{slug}', [OfferController::class, 'show'])->name('storefront.offers.show');
    Route::get('/outlets', [OutletController::class, 'index'])->name('storefront.outlets');
...
Route::prefix('bn')->name('bn.')->group($registerTenantRoutes);
